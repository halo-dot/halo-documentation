...
* currency code
* transaction amount
* merchant id (retrieved from the Halo <a href="https://go.merchantportal.prod.haloplus.io/" target="_blank">Merchant Portal</a>)
* timestamp
...
| Name          | Type   | Description                                                                                                                                                                                                                                   |
| ------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| expiryMinutes | Number | Duration for which the intent session token should last before it expires. If not provided, the session token will expire after 1 hour/60 minutes. If specified please note the min value is 60 minutes and the max value is 720 minutes. |
...
You will need a `API Key` and `Merchant ID` from the <a href="https://go.merchantportal.prod.haloplus.io/" target="_blank">Merchant Portal</a> for this API call. The response will contain a deep link that can be used to invoke the Halo.Go/Halo.Link app.
...
You will need an `API Key` and a `Merchant ID` from the <a href="https://go.merchantportal.prod.haloplus.io/" target="_blank">Merchant Portal</a> for this API call. The response will contain a deep link that can be used to invoke the Halo.Go/Halo.Link app.
