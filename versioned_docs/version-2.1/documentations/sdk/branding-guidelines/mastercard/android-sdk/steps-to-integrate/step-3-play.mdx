...
For complete list of StatusCode, click <a href="https://developer.mastercard.com/mastercard-sonic-branding/documentation/android/code-and-formats/#status-code" target="_blank">here</a>.
