...
app.post('/api/login', (req, res) => {
  ...
  const payload = {
    ...
    sub: 'MCH-12345',
    usr: username,
    aud: 'kernelserver.go.dev.haloplus.io',
    iat: now,
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody Map<String, String> body) {
        ...
        String token = JWT.create()
                ...
                .withSubject("MCH-12345")
                .withClaim("usr", username)
                .withAudience("kernelserver.go.dev.haloplus.io")
                .withIssuedAt(now)
                .withExpiresAt(now.plusSeconds(86400))
                .withClaim("refresh_token", false)
                .withClaim("x-tid", "TID-9999")
                .withClaim("mcc", "5732")
                .withClaim("mbn", "My Store")
                .withClaim("tpid", "TPID-001")
                .sign(algorithm);
