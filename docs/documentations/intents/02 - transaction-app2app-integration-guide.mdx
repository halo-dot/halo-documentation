...
You will need a `API Key` and `Merchant ID` from the <a href="https://go.merchantportal.prod.haloplus.io/" target="_blank">Merchant Portal</a> for this API call. The response will contain a link that can be used to invoke the Halo.Go/Halo.Link app.
