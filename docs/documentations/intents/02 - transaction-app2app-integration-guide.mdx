...
You will need a `API Key` and `Merchant ID` from the [Merchant Portal](https://go.merchantportal.prod.haloplus.io/) for this API call. The response will contain a link that can be used to invoke the Halo.Go/Halo.Link app.
