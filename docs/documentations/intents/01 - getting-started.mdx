...
The combination of the MerchantID and the API-Key will be used to make API request to the backend see [Intent Transaction](/docs/documentations/intents/transaction-app2app-integration-guide#2-android-intents-api) for more details.
